...
export type { User, Game, Team, Player, TeamMember, Rating, Tournament, TournamentTeam, Match, MatchEvent, Permission, RolePermission, UserPermission, UserPermissionItem } from '../generated/prisma/client';
